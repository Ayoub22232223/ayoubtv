...
.jw-state-idle .jw-display-controls .jw-display-icon-container .jw-icon path {
  display: none;
}

.jw-state-idle .jw-display-controls .jw-display-icon-container .jw-icon {
  background-image: url("data:image/svg+xml;base64,");
  background-size: contain;
  background-repeat: no-repeat;
}
...
.modal .modal-container .modal-header::after {
  ...
  border-radius: 0.7rem 0.3rem 0 0;
}

.modal .modal-container .modal-header .backdrop {
  width: 100%;
  height: 30rem;
  border-radius: 0.7rem 0.rem 0 0;
}
...
.jwplayer.jw-skin-netflix.jw-state-idle
  .jw-display-icon-container
  .jw-svg-icon-play {
  background-image: url("data:image/svg+xml;base64,");
  background-repeat: no-repeat;
...
.jwplayer.jw-skin-netflix.jw-state-idle
  ...
  .jw-svg-icon-play {
  background-image: url("data:image/svg+xml;base64,");
  background-repeat: no-repeat;
  background-position: center;
  -webkit-transition: 0.2s;
  transition: 0.2s;
...
/*
AmplÃ­a la imagen y aÃ±ade transiciones.
*/
...
/*
Deslizar la imagen hacia la izquierda 4rem.
*/
.jwplayer.jw-skin-netflix.jw-state-complete:hover .jw-preview {
  transform: translate3d(-4rem, 0, 0);
}
...
/*
Cambiar el color de la barra de control y modificar el color del icono en estado inactivo.
*/
...
/*
AcÃ©rcate las ayudas emergentes a la barra, cambia los colores y elimina las sombras.
*/
...
/*
Tooltip timeslider e botones de calidad y leyenda.
*/
...
.jwplayer.jw-skin-netflix .jw-time-thumb {
  border-radius: 0.7rem 0.3rem 0 0 !important;
}
...
/*
TamaÃ±o y color del deslizador. 
*/
.jwplayer.jw-skin-netflix
  .jw-controlbar
  .jw-slider-time
...
/*
Color del menÃº de configuraciÃ³n.
*/
...
/*
Icono de velocidad de reproducciÃ³n y configuraciÃ³n de subtÃ­tulos
*/
...
.jw-svg-icon-pause {
  background-image: url("data:image/svg+xml;base64,");
  background-size: contain;
  background-repeat: no-repeat;
}
...
.jw-svg-icon-settings {
  background-image: url("data:image/svg+xml;base64,");
  background-size: contain;
  background-repeat: no-repeat;
}
...
.jw-svg-icon-rewind {
  background-image: url("data:image/svg+xml;base64,");
  background-size: contain;
  background-repeat: no-repeat;
}
...
.jw-svg-icon-quality-100 {
  background-image: url("data:image/svg+xml;base64,");
  background-size: contain;
  background-repeat: no-repeat;
}
...
.jw-svg-icon-close {
  background-image: url("data:image/svg+xml;base64,");
  background-size: contain;
  background-repeat: no-repeat;
}
...
.jw-svg-icon-cc-off {
  background-image: url("data:image/svg+xml;base64,");
  background-size: contain;
  background-repeat: no-repeat;
}
...
.jw-icon-cc .jw-svg-icon-cc-on {
  background-image: url("data:image/svg+xml;base64,");
  background-size: contain;
  background-repeat: no-repeat;
}
...
.jw-svg-icon-volume-100 {
  background-image: url("data:image/svg+xml;base64,");
  background-size: contain;
  background-repeat: no-repeat;
}
...
.jw-svg-icon-volume-50 {
  background-image: url("data:image/svg+xml;base64,");
  background-size: contain;
  background-repeat: no-repeat;
}
...
.jw-svg-icon-volume-0 {
  background-image: url("data:image/svg+xml;base64,");
  background-size: contain;
  background-repeat: no-repeat;
}
...
.jw-svg-icon-fullscreen-on {
  background-image: url("data:image/svg+xml;base64,");
  background-size: contain;
  background-repeat: no-repeat;
}
...
.jw-svg-icon-fullscreen-off {
  background-image: url("data:image/svg+xml;base64,");
  background-size: contain;
  background-repeat: no-repeat;
}

.jw-icon-fullscreen:hover .jw-svg-icon-fullscreen-off {
  background-image: url("data:image/svg+xml;base64,");
}
...
.jw-svg-icon-sharing {
  background-image: url("data:image/svg+xml;base64,");
  background-repeat: no-repeat;
  background-position: center;
  -webkit-transition: 0.2s;
  transition: 0.2s;
...
.jwplayer.jw-skin-netflix .jw-svg-icon-audio-tracks {
  background-image: url("data:image/svg+xml;base64,");
  background-size: contain;
  background-repeat: no-repeat;
}
...
.jw-svg-icon-buffer {
  background-image: url("data:image/svg+xml;base64,");
  background-size: contain;
  background-repeat: no-repeat;
}

/* En Directo */
.jw-icon.jw-icon-inline.jw-button-color.jw-reset.jw-text-live path {
  display: none;
}
...
.jw-icon.jw-icon-inline.jw-button-color.jw-reset.jw-text-live:hover {
  background-color: #FA1B5E;
  color: #FFF;
  padding: 5px 10px;
  border-radius: 15px;
...
.jw-breakpoint-7 .jw-text-elapsed {
  ...
  // إعداد بيانات الطلب
const url = "https://yallagoall.com/TOD/WEB/BEIN/bs1.php";
const headers = {
  "Content-Type": "application/x-www-form-urlencoded",
  "Referer": "https://www.high-kora.com/"
};
const body = ""; // يمكنك تعديل المحتوى إذا كان هناك بيانات تحتاج إلى إرسالها
...
fetch(url, {
  ...
  .then(response => {
    ...
    return response.text(); // استلام النص الكامل للرد
  })
  .then(data => {
    // تحليل البيانات للحصول على stream_url
    const startStr = ",\"stream_url\":\"";
    const endStr = "\",";
    const startIndex = data.indexOf(startStr);
    const endIndex = data.indexOf(endStr, startIndex + startStr.length);

    if (startIndex !== -1 && endIndex !== -1) {
      const streamUrl = data.substring(startIndex + startStr.length, endIndex);
      console.log("Stream URL:", streamUrl); // عرض الرابط في وحدة التحكم
    } else {
      console.error("لم يتم العثور على stream_url في الرد.");
    }
  })
  .catch(error => {
        ...
        playerInstance.setup({
            playlist: [{
                sources: [{
                    ...
                    drm: {
                        clearkey: {
                            keyId: "dece176768f639bcbaf97ebca9c74164",
                            key: "dd5f1f0bfe87b23eb94160af51671670"
                        }
                    },
                    label: "HD"
                }]
